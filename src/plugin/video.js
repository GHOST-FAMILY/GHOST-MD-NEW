      ...
      if (isUrl) {
        ...
        videoStream.on('end', async () => {
          try {
            ...
            await Matrix.sendMessage(m.from, { video: finalVideoBuffer, mimetype: 'video/mp4', caption: '© ᴘᴏᴡᴇʀᴅ ʙʏ ɢʜᴏꜱᴛ-ᴍᴅ ᴠ3' }, { quoted: m });
            await m.React("🎥");
          } catch (err) {
        ...
        if (!firstVideo) {
          m.reply('ඔයාට Download කරගන්න ඕනා Video name එක type කරන්න.');
          await m.React("🙆‍♂️");
          return;
        }
